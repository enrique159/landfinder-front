  ...
  <div class="container about-us">
    <div class="row">
      <div class="col-12 col-md-6 mb-5 px-0 px-md-5">
        <h2 class="ff-secondary ts-biggest mb-5">Somos la oficina consultora inmobiliaria <span class="tc-complementary-1"> No. 1</span> de Baja California Sur
        </h2>
      ...
      <div class="col-12 col-md-6 order-1 order-md-0">
        <div class="technicals-grid">
          <div class="card-detail px-4 d-flex justify-content-center flex-column">
            ...
            <h2 class="ff-secondary ts-h2">100</h2>
